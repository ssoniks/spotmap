...
<style scoped>
/* --- FIX: Apply Border Box Globally in Component --- */
* {
...
@media (min-width: 768px) {
  .sidebar-toggle.is-open {
    left: 380px; /* 360px sidebar + 20px padding */
  }
}
...
.sidebar-header {
  ...
  min-width: 360px; /* Now fits because of border-box */
}
...
.spot-info h3 { font-size: 1rem; margin-bottom: 4px; color: white; }
.spot-tag {
...
.card-action {
  width: 32px; height: 32px; background: #1a1a1a; border-radius: 50%; display: flex;
